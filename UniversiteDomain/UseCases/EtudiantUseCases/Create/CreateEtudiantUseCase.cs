...
public class CreateEtudiantUseCase(IEtudiantRepository repositoryFactory)
{
    ...
    public async Task<Etudiant> ExecuteAsync(Etudiant etudiant)
    {
        ...
        Etudiant et = await repositoryFactory.CreateAsync(etudiant);
    ...
    private async Task CheckBusinessRules(Etudiant etudiant)
    {
        ...
        List<Etudiant> existe = await repositoryFactory.FindByConditionAsync(e=>e.NumEtud.Equals(etudiant.NumEtud));
        ...
        existe = await repositoryFactory.FindByConditionAsync(e=>e.Email.Equals(etudiant.Email));
